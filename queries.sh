...
echo "$($PSQL "SELECT name FROM teams, games   WHERE winner_id=team_id AND year=2018 AND round='Final'")"
...
echo "$($PSQL "SELECT year, name FROM teams, games   WHERE winner_id=team_id AND  round='Final' ORDER BY name DESC")"
